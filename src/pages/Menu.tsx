...
export default function Menu() {
    ...
    return (
        <div className="h-screen bg-background-dark text-primary px-6 py-12">
            {/* 頂部標題 */}
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-4 justify-between items-center border-b border-primary/30 pb-6 mb-6">
                <div>
                    <h1 className="font-serif text-3xl font-bold tracking-widest text-primary">歡迎回來，{user?.username || '神祕巫師'}</h1>
