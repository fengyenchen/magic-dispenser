    ...
    return (
        ...
        >
            <div className="w-full max-w-xs p-6 border border-primary/30 bg-background-dark/40 rounded-md text-center font-mono text-primary">
                <div className="text-[10px] opacity-60 mb-3 tracking-widest uppercase">{title}</div>

                {/* 日誌 */}
                <div className="h-8 text-[12px] text-primary/80 mb-3 flex items-center justify-center font-serif italic px-2">
                    {currentLog}
                </div>
